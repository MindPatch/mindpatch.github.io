...
date: "2025-04-28"
description: "Complete writeup for all web challenges from CIT CTF 2025, including SSTI exploitation, LFI bypasses, git repository enumeration, and SQL injection techniques."
tags: [CTF, web security, SSTI, LFI, SQL injection, git enumeration, flask]
categories: [CTF]
image: https://miro.medium.com/v2/resize:fit:952/1*kvW3lucpnNq6fTtQ9Y_BBA.png
---
